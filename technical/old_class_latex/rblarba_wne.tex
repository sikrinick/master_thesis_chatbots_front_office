...
% Dostosowanie do potrzeb WNE - Pawe³ Strawiñski, 05.05.2008
...
\kierunek{Informatyka i Ekonomoetria}

% finanse i bankowoœæ, informatyka i ekonometria - nie okreslamy zakresu (opcja zakomentowana)
% ekonomia - zakres
% dla prac licencjackich nie jest wymagany,
% dla prac magisterskich przyjmuje jedna z wartosci:
% {ekonomi integracji europejskiej}
% {ekonomii przedsiebiorstwa}
...
% Katedra albo Zak³ad
% ew. Wydzia³ ew. Uczelnia (je¿eli nie WNE UW))
...
% ustawienia interlinii (odstêpów miêdzy wierszami)
