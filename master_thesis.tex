...
\summarypl{
    ...
    Kolejna wersja tej Dyrektywy (znana pod nazwą PSD2) wywołała nową falę cyfryzacji banków kierując swe zmiany w stronę otwartości infrastuktury IT, wykorzystania Big Data i integracji z firmami zewnętrznymi.
